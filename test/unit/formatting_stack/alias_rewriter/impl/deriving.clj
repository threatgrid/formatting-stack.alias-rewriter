...
(deftest derivations
  (are [desc the-ns-name current-ns-aliases project-aliases expected]
       (testing [desc the-ns-name current-ns-aliases project-aliases]
         (is (= expected
                (sut/derivations 'sample the-ns-name current-ns-aliases project-aliases)))
         true)
    #_the-ns-name #_current-ns-aliases #_project-aliases   #_expected
...
(deftest correct-ns-aliases-for
  (are [desc current-ns-aliases acceptable-aliases-whitelist expected]
       (testing desc
         (is (= expected
                (sut/correct-ns-aliases-for 'sample current-ns-aliases (atom {}) acceptable-aliases-whitelist)))
         true)
