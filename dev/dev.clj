...
(defn suite []
  (refresh)
  (run-all-tests #".*\.formatting-stack\.alias-rewriter.*"))

(defn unit []
  (refresh)
  (run-all-tests #"unit\.formatting-stack\.alias-rewriter.*"))

(defn slow []
  (refresh)
  (run-all-tests #"integration\.formatting-stack\.alias-rewriter.*"))
